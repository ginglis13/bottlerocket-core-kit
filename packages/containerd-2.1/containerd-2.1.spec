...
Source8: image-verification-toml
Source9: image-digest-allowlist
...
install -p -m 0644 %{S:2} %{S:3} %{S:4} %{S:6} %{S:7} %{S:8} %{S:9} %{buildroot}%{_cross_templatedir}
...
%{_cross_templatedir}/image-verification-toml
%{_cross_templatedir}/image-digest-allowlist
